...
def do_docling_extraction(df: pd.DataFrame, max_workers=8, output_dir=None) -> pd.DataFrame:
    """
    ...
    print("[Step 9/11] Extracting text/tables/formulas via Docling (Multiprocessing Dual GPU Debug)...")
