# -*- coding: utf-8 -*-
"""
Multiprocessing Multi-GPU Docling VLM extraction - PROPERLY USING DocumentConverter
...
def extract_pdf_with_docling(pdf_path):
    ...
    In the child process, reinitialize the DocumentConverter with VLM pipeline,
    convert the PDF, and return the results.
    """
