...
def worker_initializer():
    ...
    import logging
    LOG_FILE = "/mnt/c/Users/alex/Desktop/docling_mod/scripts/logs/docling_testing.log"
    ...
    with ProcessPoolExecutor(max_workers=max_workers, initializer=worker_initializer) as executor:
        ...
        for future in as_completed(futures):
            ...
            try:
                ...
                df.at[idx, "NumPages"] = result["NumPages"]
                df.at[idx, "NumTables"] = result["NumTables"]
                df.at[idx, "NumPictures"] = result["NumPictures"]
                ...
                if result["Error"]:
                    ...
                    logging.info(f"Extraction successful row {idx}, pages={result['NumPages']}, tables={result['NumTables']}, tokens={result['TokenCount']}")
                ...
                df.at[idx, "NumPages"] = 0
                df.at[idx, "NumTables"] = 0
                df.at[idx, "NumPictures"] = 0
