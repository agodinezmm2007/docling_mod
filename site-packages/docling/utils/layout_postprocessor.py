...
class LayoutPostprocessor:
    ...
    def __init__(
        self, page: Page, clusters: list[Cluster], options: LayoutOptions, page_number: int
    ) -> None:
...
#--------------------------------------------------------------
        ...
        combined_clusters = self._merge_vertically_adjacent_formulas(combined_clusters)         
