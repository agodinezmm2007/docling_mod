...
class VlmPipelineOptions(PaginatedPipelineOptions):
    # Generate images of pages for downstream tasks.
    generate_page_images: bool = True
    
    # If True, backend text is prioritized over generated text.
    force_backend_text: bool = False
    
    # Code and formula OCR/enrichment
    do_code_enrichment: bool = False
    do_formula_enrichment: bool = False
    
    # (Optional) Picture description/classification
    do_picture_classification: bool = False
    do_picture_description: bool = False
    
    # Specify VLM model options
    vlm_options: HuggingFaceVlmOptions = smoldocling_vlm_conversion_options
